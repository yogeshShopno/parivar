  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 max-h-[76vh] overflow-y-auto pr-1 select-none text-text">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm uppercase font-bold text-text-secondary mb-1.5">{member ? 'Strong Password' : 'Strong Password *'}</label>
      ...
      {canManageRoleFields && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm uppercase font-bold text-text-secondary mb-1.5">Role </label>
            <select
            ...
            {errors.role_id && <p className="text-error-text text-sm mt-1 font-semibold">{errors.role_id}</p>}
          </div>
          <div>
            <label className="block text-sm uppercase font-bold text-text-secondary mb-1.5">Designation *</label>
            <input
              type="text"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm uppercase font-bold text-text-secondary mb-1.5">Image (300*300 px, Max size 1 mb)</label>
