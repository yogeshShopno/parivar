...
import { Home, Users, Briefcase, FileText, Settings, Shield } from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-[#0d1325]/80 backdrop-blur-xl border-r border-white/[0.06] h-screen p-6 flex flex-col fixed left-0 top-0 z-30 shadow-glass-md">
      {/* Brand Logo Header */}
