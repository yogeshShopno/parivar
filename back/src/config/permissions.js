...
const PERMISSIONS = [
  ...
  { key: 'posts.list', label: 'Feed Posts List', module: 'posts', module_label: 'Feed Posts', action: 'list', action_label: 'List' },
  { key: 'posts.add', label: 'Feed Posts Add', module: 'posts', module_label: 'Feed Posts', action: 'add', action_label: 'Add' },
  { key: 'posts.edit', label: 'Feed Posts Edit', module: 'posts', module_label: 'Feed Posts', action: 'edit', action_label: 'Edit' },
  { key: 'posts.delete', label: 'Feed Posts Delete', module: 'posts', module_label: 'Feed Posts', action: 'delete', action_label: 'Delete' },
